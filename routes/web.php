...
Route::middleware(['auth:usr,emp'])->group(function () {
    ...
    Route::get('/empresas/{empresa}', [AdminController::class, 'empresa'])->name('empresas.show');
    Route::get('/empresas/{empresa}/editar', [EmpresasController::class, 'edit'])->name('empresas.edit');
    Route::get('/lista-empresas', [AdminController::class, 'listaEmpresas'])->name('lista.empresas');
